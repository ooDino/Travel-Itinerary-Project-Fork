...
api_key = '1c6f74f594msh91beeb6fdd44db5p134317jsn07c6d312b55e'
...
class Flight:
  ...
  def __str__(self):
    return f"From Airport: {self.from_airport}\n" \
...
def flights_finder(originSkyId,destinationSkyId,originEntityId,destinationEntityId,departure_date,arrival_date,adults=1):

    url = "https://sky-scrapper.p.rapidapi.com/api/v1/flights/searchFlights"

    querystring = {"originSkyId": originSkyId, "destinationSkyId": destinationSkyId, "originEntityId": originEntityId,
                   "destinationEntityId": destinationEntityId, "date": departure_date, 'returnDate':arrival_date,
                   "currency": "USD", "market": "en-US", "countryCode": "US", 'adults':adults,}
